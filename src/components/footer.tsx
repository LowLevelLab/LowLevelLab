      ...
      <div className="max-w-[1400px] mx-auto px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 lg:gap-24 mb-16">
          ...
          <div className="col-span-1 md:col-span-2 flex flex-col items-start">
            ...
            <p className="text-neutral-400 font-light mb-8 max-w-sm leading-relaxed">
              Open-source collective building compilers, allocators, and bare-metal infrastructure.
            </p>
            <div className="text-neutral-500 text-[13px] font-light flex flex-col gap-1.5">
              <span>Made by LowLevelLabs</span>
          ...
          <div className="flex flex-col">
            ...
            <div className="flex flex-col gap-4">
              <a
                href="https://discord.gg/v7PmFhyZhW"
                target="_blank"
